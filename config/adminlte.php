...
return [
    ...
    */
    ...
    'logo' => '<i>Just<b>CRM</b></i>',
    'logo_img' => 'vendor/adminlte/dist/img/logo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'vendor/adminlte/dist/img/logo.png',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'permission' => ['view-project-statistic'],
                ],
            ],
        ],
        [
        ...
        'jqueryui' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.13.2/themes/base/jquery-ui.min.css',
                ],
            ],
        ],
        'fontawesome ' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/js/all.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css',
                ],
            ],
        ],
        'bootstrap-fileinput ' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/5.5.2/js/fileinput.min.js',

                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/5.5.2/css/fileinput-rtl.min.css',
                ],
            ],
        ],
        'toastr ' => [
        ...
        'fullcalendar' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/fullcalendar/6.1.4/index.global.min.js',
                ],
            ],
        ],
        'Sweetalert2' => [
